...
def main(args):
    ...
    cmd = command(
        experiment_name="SIRS_generate_nash_equilibrium_results",
        code="./",
        command="python -m experiments.sirs_with_confinements.generate_nash_equilibrium_results --output_dir ./outputs",
