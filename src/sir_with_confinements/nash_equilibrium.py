...
def main(args):
    ...
    plt.savefig(
        os.path.join(
            f"nash_plt_{args.N}_{args.encounter_rate*args.N}_{args.encounter_rate*args.N}_{args.cost_infection}_{args.cost_lockdown}.png",
        )
    )
    plt.show(block=True)
    print(0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--encounter_rate", type=float, default=0.1)
